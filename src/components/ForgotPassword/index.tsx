...
const FirstPage: React.FC<PageProps> = ({ onNext }) => {
  ...
  return (
    <>
      ...
      <DialogContent>
        <Typography sx={{ mb: 3 }}>
          Digite seu e-mail para receber o token de verificação
        </Typography>
      ...
      <DialogActions>
        <Button
          variant="contained"
          sx={{
            backgroundColor: "#F00E3D",
            color: "white",
            "&:hover": { backgroundColor: "#F00E3D" },
          }}
          onClick={onNext}
          disabled={!btnNext}
          className={btnNext ? styles.btnNext : undefined}
        >
          Próximo
        </Button>
      </DialogActions>
